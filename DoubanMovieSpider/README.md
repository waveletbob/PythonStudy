...
豆瓣采用https，利用socket可以网络连接获取；对网页URL构造然后获取HTML信息，之后取其中关键信息存入数据结构中。
## 标签 ##

# DoubanMovieSpider

@(waveletbob)[Python|爬虫|豆瓣电影、豆瓣图书]
...
----------
Thank you for reading this manual. Now please press `Ctrl + M` and click `Link with Evernote`. Enjoy your **Spider** journey!
